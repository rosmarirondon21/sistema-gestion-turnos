                    ...
                    <div class="simplebar-offset" style="right: 0px; bottom: 0px;">
                        <div class="simplebar-content-wrapper" style="height: 100%; overflow: hidden scroll;">
                            <div class="simplebar-content" style="padding: 0px;">
                                ...
                                <div id="sidebar-menu">
                                    <ul id="side-menu">
                                        <li class="<?php echo $_SERVER["HTTP_HOST"] . $_SERVER["REQUEST_URI"] == $_SERVER["HTTP_HOST"] . '/perfilAdministrador' ? 'menuitem-active' : '' ?>">
                                        ...
                                        <li class="<?php echo $_SERVER["HTTP_HOST"] . $_SERVER["REQUEST_URI"] == $_SERVER["HTTP_HOST"] . '/horarios' ? 'menuitem-active' : '' ?>">
                                            <a href="/horarios">
                                        ...
                                        <li class=<?php echo $_SERVER["HTTP_HOST"] . $_SERVER["REQUEST_URI"] == $_SERVER["HTTP_HOST"] . '/usuarios' ? 'menuitem-active' : '' ?>>
                                            <a href="/usuarios">
    ...
    <!-- Left Sidebar End --><?php /**PATH C:\laragon\www\sistema-gestion-turnos\resources\views/menuAdministrador.blade.php ENDPATH**/ ?>